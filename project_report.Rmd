...
```{r}
setwd("C:/Users/sudeep/Documents/DataScience/MachineLearning")
a=read.csv('data/pml-training.csv',na.strings=c('','NA'))
...
```{r}
d=read.csv('data/pml-testing.csv',na.strings=c('','NA'))
